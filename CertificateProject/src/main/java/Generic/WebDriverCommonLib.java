...
public class WebDriverCommonLib {
	...
	public void waitForpageToLoad() {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(Constants1.globalWait));
	}
	...
	public void waitForWebElementTobeVisible(By by) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(Constants1.globalWait));
